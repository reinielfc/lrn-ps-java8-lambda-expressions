...
public class ChainingLambdas {
    public static void main(String[] args) {
        ...
        System.out.println("For null = " + isNotNullAndNotEmpty.test(null));
        System.out.println("For empty = " + isNotNullAndNotEmpty.test(""));
        System.out.println("For Hello = " + isNotNullAndNotEmpty.test("Hello"));
    }
}
